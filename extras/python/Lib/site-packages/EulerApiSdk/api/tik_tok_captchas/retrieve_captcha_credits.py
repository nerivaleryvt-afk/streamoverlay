...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CaptchaCreditsResponse | None:
...
) -> Response[CaptchaCreditsResponse]:
    return Response(
