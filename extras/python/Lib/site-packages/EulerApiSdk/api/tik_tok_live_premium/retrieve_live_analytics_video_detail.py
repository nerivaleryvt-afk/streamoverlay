...
from ...models.live_analytics_video_detail_api_response import LiveAnalyticsVideoDetailAPIResponse
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/webcast/live_analytics/video_detail",
        "params": params,
    }
...
) -> LiveAnalyticsVideoDetailAPIResponse | None:
    if response.status_code == 200:
        response_200 = LiveAnalyticsVideoDetailAPIResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[LiveAnalyticsVideoDetailAPIResponse]:
    return Response(
