...
class WebcastLiveAnalyticsUserInteractionsResponseUserAttr:
    """
    Attributes:
        admin_permissions (RecordStringUnknown): Construct a type with a set of properties K of type T
    ...
    admin_permissions: RecordStringUnknown
    has_voting_function: bool
    is_admin: bool
    is_channel_admin: bool
    is_muted: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        admin_permissions = RecordStringUnknown.from_dict(d.pop("admin_permissions"))
