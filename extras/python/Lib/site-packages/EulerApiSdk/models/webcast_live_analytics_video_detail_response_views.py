...
T = TypeVar("T", bound="WebcastLiveAnalyticsVideoDetailResponseViews")


@_attrs_define
class WebcastLiveAnalyticsVideoDetailResponseViews:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webcast_live_analytics_video_detail_response_views = cls(
            anchor_live_acu=anchor_live_acu,
            average_watch_time=average_watch_time,
            top_viewer_count=top_viewer_count,
            total_views=total_views,
        ...
        return webcast_live_analytics_video_detail_response_views
