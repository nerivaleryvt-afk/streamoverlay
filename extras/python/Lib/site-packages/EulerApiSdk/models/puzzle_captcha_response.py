...
T = TypeVar("T", bound="PuzzleCaptchaResponse")


@_attrs_define
class PuzzleCaptchaResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        puzzle_captcha_response.additional_properties = d
        return puzzle_captcha_response
