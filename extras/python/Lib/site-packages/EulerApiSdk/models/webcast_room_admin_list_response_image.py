...
T = TypeVar("T", bound="WebcastRoomAdminListResponseImage")


@_attrs_define
class WebcastRoomAdminListResponseImage:
    """
    Attributes:
        avg_color (str):
        height (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webcast_room_admin_list_response_image = cls(
            avg_color=avg_color,
            height=height,
            image_type=image_type,
            is_animated=is_animated,
        ...
        return webcast_room_admin_list_response_image
